...
const cards = {
  birthday1: {
    ...
    attachments: [
      {
        filename: "gif",
        path: `${publicFolderPath}/birthday1.gif`,
    ...
    attachments: [
      {
        ...
        path: `${publicFolderPath}/birthday2.gif`,
    ...
    attachments: [
      {
        ...
        path: `${publicFolderPath}/birthday3.gif`,
        cid: "unique@nodemailer.com",
      },
    ],
    html: `<!DOCTYPE html>
  ...
  xmas1: {
    ...
    attachments: [
      {
        filename: "xmas1_img",
        path: `${publicFolderPath}/xmas1.gif`,
        cid: "unique@nodemailer.com",
      },
    ],
    html: `<!DOCTYPE html>
  ...
  xmas2: {
    ...
    attachments: [
      {
        filename: "xmas2_gif",
        path: `${publicFolderPath}/xmas2.gif`,
        cid: "gif@nodemailer.com",
      },
      {
        filename: "xmas2_png",
        path: `${publicFolderPath}/xmas2_2.png`,
    ...
    attachments: [
      {
        ...
        path: `${publicFolderPath}/valentines1.gif`,
        cid: "valentines1@nodemailer.com",
      },
      {
        filename: "valentines1_1_png",
        path: `${publicFolderPath}/valentines1_1.gif`,
    ...
    attachments: [
      {
        ...
        path: `${publicFolderPath}/valentines2.gif`,
  ...
  funny1: {
    ...
    attachments: [
      {
        filename: "funny1_gif",
        path: `${publicFolderPath}/funny1.gif`,
  ...
  funny2: {
    ...
    attachments: [
      {
        filename: "png",
        path: `${publicFolderPath}/funny2.png`,
        cid: "png@nodemailer.com",
      },
      {
        filename: "gif",
        path: `${publicFolderPath}/funny2_3.gif`,
        cid: "gif@nodemailer.com",
      },
    ],
    html: `<!DOCTYPE html>
  ...
  funny3: {
    ...
    attachments: [
      {
        filename: "gif",
        path: `${publicFolderPath}/funny3_2.gif`,
        cid: "gif2@nodemailer.com",
      },
      {
        filename: "gif",
        path: `${publicFolderPath}/funny3.gif`,
        cid: "gif@nodemailer.com",
      },
    ],
    html: `<!DOCTYPE html>
  ...
  funny4: {
    ...
    attachments: [
      {
        filename: "gif",
        path: `${publicFolderPath}/funny4.gif`,
        cid: "gif@nodemailer.com",
      },
    ],
    html: `<!DOCTYPE html>
  ...
  funny5: {
    ...
    attachments: [
      {
        filename: "gif",
        path: `${publicFolderPath}/funny5.gif`,
        cid: "gif@nodemailer.com",
      },
    ],
    html: `<!DOCTYPE html>
  ...
  funny6: {
    ...
    attachments: [
      {
        filename: "gif",
        path: `${publicFolderPath}/funny6.gif`,
        cid: "gif@nodemailer.com",
      },
    ],
    html: `<!DOCTYPE html>
  ...
  funny7: {
    ...
    attachments: [
      {
        filename: "gif",
        path: `${publicFolderPath}/funny7.gif`,
        cid: "gif@nodemailer.com",
      },
    ],
    html: `<!DOCTYPE html>
  ...
  custom1: {
    ...
    attachments: [
      {
        filename: "gif",
        path: `${publicFolderPath}/custom1.gif`,
        cid: "gif@nodemailer.com",
      },
    ],
    html: (customMessage) => {
  ...
  custom2: {
    ...
    attachments: [
      {
        filename: "gif",
        path: `${publicFolderPath}/custom2.gif`,
        cid: "gif@nodemailer.com",
      },
      {
        filename: "gif",
        path: `${publicFolderPath}/custom2_2.gif`,
        cid: "gif2@nodemailer.com",
      },
    ],
    html: (customMessage) => {
  ...
  custom3: {
    ...
    attachments: [
      {
        filename: "gif",
        path: `${publicFolderPath}/custom3.gif`,
        cid: "gif@nodemailer.com",
      },
    ],
    html: (customMessage) => {
